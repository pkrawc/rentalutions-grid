...
var Column = _styledComponents2.default.div.attrs({
  ...
  return xs ? getPercent(xs, columns) : '100%';
}, function (_ref2) {
  var xs = _ref2.xs,
...
}, _variables.sizes.small, function (_ref4) {
  var xs = _ref4.xs,
      sm = _ref4.sm,
  ...
  return sm ? getPercent(sm, columns) : xs ? getPercent(xs, columns) : '100%';
}, _variables.sizes.medium, function (_ref6) {
  var xs = _ref6.xs,
      sm = _ref6.sm,
      md = _ref6.md,
  ...
  return md ? getPercent(md, columns) : sm ? getPercent(sm, columns) : xs ? getPercent(xs, columns) : '100%';
}, _variables.sizes.large, function (_ref8) {
  var xs = _ref8.xs,
      sm = _ref8.sm,
      md = _ref8.md,
      lg = _ref8.lg,
  ...
  return lg ? getPercent(lg, columns) : md ? getPercent(md, columns) : sm ? getPercent(sm, columns) : xs ? getPercent(xs, columns) : '100%';
}, _variables.sizes.xLarge, function (_ref10) {
  var xs = _ref10.xs,
      sm = _ref10.sm,
      md = _ref10.md,
      lg = _ref10.lg,
